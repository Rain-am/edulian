...
def _build_row_from_item(item: ShipmentItem, sku_info: SkuInfo, quantity: Decimal) -> CustomsRow:
    return _build_row(
        ...
        sku_info=sku_info,
        quantity=quantity,
        purchase_entity=item.purchase_entity or PENDING,
...
def _build_row_from_batch(item: ShipmentItem, sku_info: SkuInfo, batch: PurchaseBatch, quantity: Decimal) -> CustomsRow:
    return _build_row(
        ...
        sku_info=sku_info,
        quantity=quantity,
        purchase_entity=batch.purchase_entity or item.purchase_entity or PENDING,
...
def _build_row_from_batches(item: ShipmentItem, sku_info: SkuInfo, batches: list[PurchaseBatch]) -> CustomsRow:
    return _build_row(
        ...
        purchase_entity=_combined_text(batch.purchase_entity for batch in batches) or item.purchase_entity or PENDING,
